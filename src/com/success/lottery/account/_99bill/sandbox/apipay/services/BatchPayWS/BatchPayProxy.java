...
public class BatchPayProxy implements com.success.lottery.account._99bill.sandbox.apipay.services.BatchPayWS.BatchPay {
  private String _endpoint = null;
  private com.success.lottery.account._99bill.sandbox.apipay.services.BatchPayWS.BatchPay batchPay = null;
  ...
  private void _initBatchPayProxy() {
    try {
      batchPay = (new com.success.lottery.account._99bill.sandbox.apipay.services.BatchPayWS.BatchPayServiceLocator()).getBatchPayWS();
      if (batchPay != null) {
        if (_endpoint != null)
  ...
  public com.success.lottery.account._99bill.sandbox.apipay.services.BatchPayWS.BatchPay getBatchPay() {
    if (batchPay == null)
      _initBatchPayProxy();
    return batchPay;
  }
