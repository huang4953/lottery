 ...
 *
 */
public class SMSServicePLS extends SMSService{

	private Log logger = LogFactory.getLog(SMSServicePLS.class.getName());
			...
			if(!user.isBindMobileFlag()){
				...
				if(parameters.length < 2){
					...
					if(!"10".equalsIgnoreCase(parameters[1].trim())){
						...
						//排列三机选一注
						betCode = LotteryTools.lotteryRandomBetCode(1000003);
					}
